...
- Hosting 設定は [firebase.json](/Users/Ryu/Documents/Codex/event-hub/firebase.json:1)
- Firebase project は [.firebaserc](/Users/Ryu/Documents/Codex/event-hub/.firebaserc:1) で `event-hub-feb37` を向いています
...
- フロントの保存窓口は [event-repository.js](/Users/Ryu/Documents/Codex/event-hub/public/src/event-repository.js:1) にまとめています
...
- Firebase 設定は [firebase-config.js](/Users/Ryu/Documents/Codex/event-hub/public/src/firebase-config.js:1) にあります
- 現在は `dataBackend: "firebase"` なので、起動すると Firebase Auth + Firestore を使います
- 今はオンライン試験用に `requireLogin: false` にしてあり、ログインなしでも触れます
- Firestore ルールも [firestore.rules](/Users/Ryu/Documents/Codex/event-hub/firebase/firestore.rules:1) で一時的に全開放です
